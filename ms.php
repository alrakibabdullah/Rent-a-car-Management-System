...
<div class="comtainer_fluid terms_of_head">
  <div class=" container term_of_service_head">
   <h2 class="term_of_service_h2">Terms of Service</h2><hr>
    <div>
      <h3 class="h1_letter">Miscellaneous:</h3>
      <p class="term_of_p">
...
For ReKar, at the address of its registered office, indicated in the legal notice;

For the User, at the address provided upon registration or requested by ReKar whenever required.
