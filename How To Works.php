    ...
    <div class="container-fluid bg-bg-2">
      <div class="wrapper wrapper-b-2">
             <video autoplay controls>
               <source src="img/ReKar (AR).mp4" type="video/mp4">
             </video>
             <button type="button" class="btn-btnn-2 btn btn-warning"><a class="aa" href="#"> Search For A Car</a></button>
      </div>
      <div class="wrapper wrapper-b-2">
        <h1 class="h-1">HOW IT WORKS</h1><hr height-"3px" color="red"><br>
        <div class="row justify-content-center">
          <div class="col-md-3">
            <img class="row-view-img" src="img/signup.jpg" alt="">
            <h4 class="h-4">SIGN UP</h4>
            <p class="h-4">Sign up, upload the needed documents and wait for our team to verify your renter's account.</p>
          </div>
          <div class="col-md-3">
            <img class="row-view-img" src="img/111.jpg" alt="">
            <h4 class="h-4">CHOOSE YOUR CAR</h4>
            <p class="h-4">Enter the exact dates of when you will require a car, and search within the vast database ReKar offers to choose the one you want.</p>
          </div>
          <div class="col-md-3">
            <img class="row-view-img" src="img/112.jpg" alt="">
            <h4 class="h-4">REQUEST YOUR CAR</h4>
            <p class="h-4">Choose your desired car, and request it within moments. Then wait for the owner to approve your request.</p>
          </div>
          <div class="col-md-3">
            <img class="row-view-img" src="img/handshake.jpg" alt="">
            <h4 class="h-4">MEET THE OWNER AND PICK UP THE CAR</h4>
            <p class="h-4">Coordinate with the owner to meet up and pick up the car keys, and head towards your exciting ReKar adventure.</p>
          </div>
          <div class="col-md-3">
            <img class="row-view-img" src="img/driving.jpg" alt="">
            <h4 class="h-4">ENJOY THE EXPERIENCE</h4>
            <p class="h-4">Need we say more? Experience the roads like never before without paying much.</p>
          </div>
          <div class="col-md-3">
            <img class="row-view-img" src="img/car-rent.jpg" alt="">
            <h4 class="h-4">RETURN THE CAR</h4>
            <p class="h-4" class="h-4">Meet with the owner to return the car, then rate your ReKar experience, all in no time.</p>
          </div>
        </div>
      ...
      <div class="wrapper wrapper-b-2">
        ...
        <button type="button" class="btn-btnn-2 btn btn-warning"><a class="aa" href="car-listing.php">START YOUR JOURNEY</a></button>
