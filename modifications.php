...
<div class="comtainer_fluid terms_of_head">
  <div class=" container term_of_service_head">
   <h2 class="term_of_service_h2">Terms of Service</h2><hr>
    <div>
      <h1 class="h1_letter">Modification:</h1>
      <p class="term_of_p">ReKar reserves the right to modify the Website, the App, and the Services, and to modify these Terms, including the financial terms of the Service, at its sole discretion and at any time, without prior notice.
...
These Terms cancel and replace all previous versions (if any).</p>
    </div>
