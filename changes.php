...
<div class="comtainer_fluid terms_of_head">
  <div class=" container term_of_service_head">
   <h2 class="term_of_service_h2">Terms of Service</h2><hr>
    <div>
      <h3 class="h1_letter">Changes to the Service:</h3>
      <p class="term_of_p">
          ReKar reserves the right to modify the characteristics and features of the Website, the App or the Service at any time. ReKar will inform the User of these changes by publishing them on the Website or the App, or by any other means that ReKar deems appropriate.
         </p>
    </div>
