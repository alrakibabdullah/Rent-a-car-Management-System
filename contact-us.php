...
<section class="contact_us section-padding">
  <div class="container contact_us_2">
  <h3>Contact</h3>
  <hr>
    <div  class="row">
         <div class="col-md-4">
        ...
        <div class="contact_detail">
              <?php 
$pagetype=$_GET['type'];
$sql = "SELECT Address,EmailId,Tel,Fax from tblcontactusinfo";
$query = $dbh -> prepare($sql);
...
{ ?>
          <ul>
            ...
            <li>
             ...
             <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="tel:61-1234-567-90"><?php   echo htmlentities($result->Tel); ?></a></div>
            </li>
             <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="tel:61-1234-567-90"><?php   echo htmlentities($result->Fax); ?></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
      ...
      <div class="col-md-8">
        ...
        <div class="contact_form ">
          <form  method="post">
            ...
            <div class="form-group">
              <input type="text" name="contactno" class="form-control" id="phonenumber" placeholder="Number" required>
            </div>
            <div class="form-group">
              <textarea class="form-control" name="message" rows="4" placeholder="Text Me.." required></textarea>
            </div>
            <div class="form-group">
